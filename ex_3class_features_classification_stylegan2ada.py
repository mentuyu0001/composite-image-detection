...
def cnn_classification_test(net, device, model_paths, weights, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2,  style_test_dir, faceapp_test_dir, stylegan2_dir, history):
    ...
    # faceapp画像の処理
    loaders, size = test_load_stylegan2adadata("D:/GraduationResearch/Features/test_stylegan2ada_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, stylegan2_dir)
