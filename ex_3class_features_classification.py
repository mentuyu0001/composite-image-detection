...
def cnn_classification_test(net, device, model_paths, weights, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2,  style_test_dir, faceapp_test_dir, history):
    ...
    # 結果保存
    with open("./Results/FinalResults/3class_features_classification.txt", "w") as ftw:
...
def Main(args):
    ...
    cnn_classification_test(net, device, model_paths, weights, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2, style_test_dir, faceapp_test_dir, history_test)
