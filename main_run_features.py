...
import psd_learning
import acf_learning
import RGBei_learning
import GRAYei_learning
import RGBlbp_learning
import GRAYlbp_learning
...
if __name__ == '__main__':
    ...
    parser.add_argument("-ep", "--epoch", type=int, default=150)
    ...
    try:
        print("Starting GRAY_EI Learning")
        GRAYei_learning.Main(args)
        print("Finished GRAY_EI Learning")
    except Exception as e:
        print(f"GRAY_EI!!! ドンマイw\nError: {e}")
    ...
    try:
        print("Starting GRAY_LBP Learning")
        GRAYlbp_learning.Main(args)
        print("Finished GRAY_LBP Learning")
    except Exception as e:
        print(f"GRAY_LBP!!! ドンマイw\nError: {e}")
