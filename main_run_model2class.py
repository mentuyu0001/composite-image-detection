...
import dct_pg_learning
import psd_pg_learning
import acf_pg_learning
import RGBei_pg_learning
import RGBlbp_pg_learning
import image_pg_learning
import dct_star_learning
import psd_star_learning
import acf_star_learning
import RGBei_star_learning
import RGBlbp_star_learning
import image_star_learning
...
if __name__ == '__main__':
    ...
    try:
        print("Starting RGB_LBP Learning")
        RGBlbp_star_learning.Main(args)
        print("Finished RGB_LBP Learning")
    except Exception as e:
        print(f"RGB_LBP!!! ドンマイw\nError: {e}")
