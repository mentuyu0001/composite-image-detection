...
def cnn_classification_test(net, device, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2,  style_test_dir, faceapp_test_dir, style2_dir, history):
    ...
    # faceapp画像の処理
    loaders, size = test_load_faceappdata("D:/GraduationResearch/Features/test_stylegan2ada_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, style2_dir)
...
def imgs_output(imgs, test_pred, target, counter, batch_size):
    ...
    dir_Style2ToPg = "./ImageStyle2adaToPg"
    dir_Style2ToStar = "./ImageStyle2adaToStar"
    dir_Style2ToStyle = "./ImageStyle2adaToStyle"
...
def Main(args):
    ...
    cnn_classification_test(net, device, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2, style_test_dir, faceapp_test_dir, stylegan2ada_test_dir, history_test)
