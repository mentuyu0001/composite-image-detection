...
def cnn_classification_test(net, device, pgmodel_paths, pgweights, starmodel_paths, starweights, stylemodel_paths, styleweights, 
    ...
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(net, device, 
                            ...
                            dir_StarToPg, dir_StarToStar, dir_StarToStyle, final_test_corect_counter, final_data_num, final_total_loss, final_f1, 2)
    
    #Real
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(net, device, pgmodel_paths, pgweights, starmodel_paths, starweights, stylemodel_paths, styleweights, 
                            dir_RealToPg, dir_RealToStar, dir_RealToStyle, final_test_corect_counter, final_data_num, final_total_loss, final_f1, 0)

    # pg画像の処理
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(net, device, 
                            pgmodel_paths, pgweights, starmodel_paths, starweights, stylemodel_paths, styleweights, 
                            dir_PgToPg, dir_PgToStar, dir_PgToStyle, final_test_corect_counter, final_data_num, final_total_loss, final_f1, 1)
    ...
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(net, device, 
                            pgmodel_paths, pgweights, starmodel_paths, starweights, stylemodel_paths, styleweights, 
                            dir_StyleToPg, dir_StyleToStar, dir_StyleToStyle, final_test_corect_counter, final_data_num, final_total_loss, final_f1, 3)
    
    # Face画像の処理
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(net, device, 
                            pgmodel_paths, pgweights, starmodel_paths, starweights, stylemodel_paths, styleweights, 
                            dir_FaceToPg, dir_FaceToStar, dir_FaceToStyle, final_test_corect_counter, final_data_num, final_total_loss, final_f1, 4)
