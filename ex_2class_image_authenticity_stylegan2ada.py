...
def cnn_classification_test(net, device, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2,  style_test_dir, faceapp_test_dir, stylegan2_dir, history):
    """
    学習したパラメータでテストを実施する。
    """
