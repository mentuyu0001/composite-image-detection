...
def cnn_classification_test(net, device, ffhq_test_dir, pggan_test_dir, star_test_dir1, star_test_dir2,  style_test_dir, faceapp_test_dir, history):
    ...
    loaders, size = test_load_realdata("D:/GraduationResearch/Features/test_2class_real_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, faceapp_test_dir)
    ...
    # 結果保存
    with open("./Results/FinalResults/2class_image_authenticity.txt", "w") as ftw:
        ftw.write("\nReal Images Score\n")
    ...
    # pggan画像の処理
    loaders, size = test_load_pggandata("D:/GraduationResearch/Features/test_2class_pg_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, faceapp_test_dir)
    ...
    # 結果保存
    with open("./Results/FinalResults/2class_image_authenticity.txt", "a") as ftw:
        ftw.write("\nPGGAN Score\n")
        ftw.write(f"Train correct / total : {str(test_correct_counter)} / {str(size)}\n")
        ftw.write(f"Train Accuracy: {str(test_correct_counter / size)}\n")
        ftw.write(f"Train F1 Score: {str(f1)}\n")
    ...
    loaders, size = test_load_stargandata("D:/GraduationResearch/Features/test_2class_star1_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, faceapp_test_dir)
    ...
    # star2画像の処理
    loaders, size = test_load_stargandata("D:/GraduationResearch/Features/test_2class_star2_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir2, style_test_dir, faceapp_test_dir)
    ...
    # style画像の処理
    loaders, size = test_load_stylegandata("D:/GraduationResearch/Features/test_2class_style_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, faceapp_test_dir)
    ...
    # faceapp画像の処理
    loaders, size = test_load_faceappdata("D:/GraduationResearch/Features/test_2class_faceapp_cache.pt", ffhq_test_dir, pggan_test_dir, star_test_dir1, style_test_dir, faceapp_test_dir)
    ...
    with open("./Results/FinalResults/2class_image_authenticity.txt", "a") as ftw:
        ftw.write("\nTotal Score\n")
        ftw.write(f"Train correct / total : {str(final_test_corect_counter)} / {str(final_data_num)}\n")
        ftw.write(f"Train Accuracy: {str(final_test_corect_counter / final_data_num)}\n")
        ftw.write(f"Train F1 Score: {str(final_f1 / final_data_num)}\n")
        ftw.write(f"Train Cross-Entropy Loss: {str(final_total_loss / final_data_num)}\n")
...
def Main(args):
    ...
    net.load_state_dict(torch.load("params/IMAGE_2class_params_cnn.pth", map_location=device, weights_only=False))
    net.to(device)
    net.eval()
