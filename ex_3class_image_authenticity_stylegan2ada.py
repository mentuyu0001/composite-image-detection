...
def cnn_classification_test(pgnet, starnet, stylenet, device, 
    ...
    final_test_corect_counter, final_data_num, final_total_loss, final_f1 = authenticityTest(pgnet, starnet, stylenet, device,
                                        dir_Style2ToPg, dir_Style2ToStar, dir_Style2ToStyle, 
                                        final_test_corect_counter, final_data_num, final_total_loss, final_f1, 5)
...
def Main(args):
    ...
    dir_Style2ToPg = args.style2topgdataimg
    dir_Style2ToStar = args.style2tostardataimg
    dir_Style2ToStyle = args.style2tostyledataimg
